...
<class="site-about">
    ...
    <div class="about-text" style="padding-left: 10%; padding-right:10%;">
        <h3 style="text-align: center;">Darkened Tunes reprezinta Clubul De Handicapati ai CNITV</h3>
        <br>
    ...
    <div class="about-text" style="padding-left: 10%; padding-right: 10%;">
        <h3 style="text-align: center;">Darkend Tunes represents the blabla</h3>
        <br>
        <div style="text-align: justify;">
