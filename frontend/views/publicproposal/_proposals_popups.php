    ...
    <div class="popup">
        ...
        <div class="container text-center">
            <div class="row">
                ...
                <div class="col">
                    <a href="<?= Url::toRoute(['publicproposal/deleteproposal', 'id' => $model->id]); ?>" class="btn btn-danger"><?= Yii::t('app', 'Da') ?></a>
                </div>
            </div>
        </div>
    </div>
...
<div id="update_proposal_popup-<?=$model->id?>">
    ...
    <div class="popup">
        ...
        <?php $form_update = ActiveForm::begin(['id' => 'form-updateproposal'.$model->id, 'type' => ActiveForm::TYPE_FLOATING, 'action' => ['publicproposal/updateproposal', 'id' => $model->id]]); ?>
