...
<th>
    <div style="width: 100%; height: 100%; position: relative; padding-left: 30px;">
        ...
        <span id="song_title"><?= Html::encode($model->setlist_spot); ?>. <?= Html::encode($model->title) ?></span>
    </div>
</th>
...
<div id="update_song_popup-<?=$model->id?>">
    ...
    <div class="popup">
        ...
        <?php $form_update = ActiveForm::begin(['id' => 'form-updatesong'.$model->id, 'layout' => 'floating', 'action' => ['song/update', 'id' => $model->id, 'page' => 'concert']]); ?>
